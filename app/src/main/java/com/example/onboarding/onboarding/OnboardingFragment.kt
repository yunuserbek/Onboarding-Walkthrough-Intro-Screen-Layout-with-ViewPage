...
import com.example.onboarding.util.SharedPreferences
    ...
    private fun initAdapter(){
        onBoardingAdapter = OnBoardingAdapter(
            listOf(
                ...
                ,OnBoardingItem(
                    R.drawable.ts,
                    requireContext().getString(R.string.on_boarding_title4),
                    requireContext().getString(R.string.description4),
                )
            )
        )
